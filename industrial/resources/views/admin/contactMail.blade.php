...
<header class="admin-header">
    ...
    <h1 style="text-align:center;font-size:25px;margin-top:30px;">send email to <span>{{ $contact->email }}</span> </h1>
    <form action="{{ route('sendContactEmail',$contact->id) }}" method="POST">
        @csrf
